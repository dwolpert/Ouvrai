...
export async function prolificListWorkspaces() {
  ...
  try {
    let res = await axios.get('https://api.prolific.com/api/v1/workspaces/', {
      headers: {
        Authorization: `Token ${process.env.PROLIFIC_AUTH_TOKEN}`,
      },
    });
...
export async function prolificListProjects(workspace) {
  ...
  try {
    let res = await axios.get(
      `https://api.prolific.com/api/v1/workspaces/${workspace.id}/projects/`,
      {
        headers: {
          Authorization: `Token ${process.env.PROLIFIC_AUTH_TOKEN}`,
        },
...
export async function prolificListMyStudies(filterStates) {
  ...
  try {
    let res = await axios.get('https://api.prolific.com/api/v1/studies/', {
      params: {
...
export async function prolificListStudiesInProject(project) {
  ...
  try {
    let res = await axios.get(
      `https://api.prolific.com/api/v1/projects/${project.id}/studies/`,
      {
        headers: {
          Authorization: `Token ${process.env.PROLIFIC_AUTH_TOKEN}`,
        },
...
export async function prolificListSubmissions(study) {
  ...
  try {
    let res = await axios.get(`https://api.prolific.com/api/v1/submissions/`, {
      params: {
        study: study?.id,
      },
      headers: {
...
export async function prolificPostStudy(studyId) {
  ...
  try {
    ...
    let res = await axios.post(
      `https://api.prolific.com/api/v1/studies/${studyId}/transition`,
      {
        action: 'PUBLISH',
      },
      {
